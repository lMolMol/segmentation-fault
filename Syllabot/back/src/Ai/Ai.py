...
API_KEY = "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" #os.getenv("API_KEY")
url = "https://openrouter.ai/api/v1/chat/completions"

info = """Syllabus for COMP 4620: Professional Practice in Computer Science (Winter 2025) Penner, C.
Faculty of Science
...
Course Title & Number: COMP 4620: Professional Practice in Computer Science
Number of Credit Hours: 3
Class Times & Locations A01: T/Th 1-2:15pm (Penner)
...
A01 and A02
Name Christina Penner (she/hers)
...
Email: * Christina.Penner@umanitoba.ca
...
7. Describe Intellectual Property, including its history and key aspects in the computer-science sociotechnical system (e.g., Artificial Intelligence).
...
Quiz
Tutorial (Jan 9) None
Jan 13/14 Case Study 0: PORN ON THE
DEAN’S COMPUTER
...
Quiz
Jan 15/16 none -
Tutorial (Jan 16) QUIZ 0 (PRACTICE)
...
strategies, and Codes of Ethics.
- Required resources (see
Content)
- Slides, including in-class
activities
...
Written Reflection
*Meet Permanent Groups
- Resources as listed Quiz 1
...
Breakout Room
Presenters: Prepare
Presentation with InClass Activity and
Discussion
Group
Presentation
2
...
• Quiz questions will be based on all material within a given block, including: 1) interactive lectures, 2) inclass activities, 3) required resources (related to course topics and and/or workshop)
...
https://umanitoba.ca/science/sites/science/files/2023-09/faculty-of-science-academic-misconductpenalties_1.pdf
...
the instructor be ill, they will work with the CS Department to find a substitute to continue teaching the class inperson.  In the event a suitable instructor cannot be found, the instructor may give the lecture synchronously or
...
skills such as time management and goal setting, reading, and note-taking, as well as learning and testtaking strategies. Writing tutors can give you feedback on your academic writing, whether you are just
...
5. Please remain off-campus and all UM facilities until cleared to return in accordance with selfassessment, testing results, and UM recommended isolation procedures.
...
found at: https://umanitoba.ca/governance/governing-documents/governing-documentsuniversity-community#sexual-violence. More information and resources can be found by
...
while token < 9:
    ...
    data = {
        "model": "cognitivecomputations/dolphin3.0-mistral-24b:free",  # or another available model like "mixtral"
        "messages": [{"role": "user", "content": f"{inp + " " + info}"}],
        "temperature": 0.7
    }
